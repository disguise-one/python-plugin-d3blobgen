...
def main():
    ...
    ret_val = d3_api_plugin(DESIGNER_IP, DESIGNER_PORT, my_add.blob(1, 2)).returnValue
    ...
    ret_val = d3_api_plugin(DESIGNER_IP, DESIGNER_PORT, use_my_add.blob(1, 2)).returnValue
    print(f"- result: {ret_val}")
