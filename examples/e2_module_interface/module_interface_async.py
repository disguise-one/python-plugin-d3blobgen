...
async def main():
    ...
    ret_val = (await d3_api_aplugin(DESIGNER_IP, DESIGNER_PORT, my_add.get_typed_execute_blob(1, 2))).returnValue
    ...
    ret_val = (await d3_api_aplugin(DESIGNER_IP, DESIGNER_PORT, use_my_add.get_typed_execute_blob(1, 2))).returnValue
    print(f"- result: {ret_val}")
